...
moire = MoireConductivity([f'../data/{lattice}/angles', 
                           f'../data/{lattice}/more_data',  
                           f'../data/{lattice}/even_more_data', 
                           f'../data/{lattice}/too_much_data'], 
                           lattice, 
                           num_layers = 2)
moire.save('../latex/graphs/data/moire/graphene')
moire.plot()